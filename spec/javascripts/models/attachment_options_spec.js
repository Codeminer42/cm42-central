...
describe('AttachmentOptions', () => {
  ...
  beforeEach(function (done) {
    ...
    const attachmentOptions = new AttachmentOptions({ refreshCallback });

    this.server = sinon.fakeServer.create();

    this.server.respondWith('GET', '/attachments/signature', [
