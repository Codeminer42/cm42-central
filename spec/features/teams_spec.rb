...
describe 'Teams' do
  ...
  context 'when user is not a team admin' do
    ...
    describe 'create team' do
      it 'should create a new team and set the user as admin', js: true do
        visit teams_path
  ...
  context 'when user is a team admin' do
    ...
    describe 'update team' do
      it 'should update a team and set a team logo', js: true do
  ...
  context 'when current user is the current team admin or the root' do
    ...
    describe 'trying to add a existing user that is not in the current team' do
      ...
      it 'should update the team with this user', js: true do
    ...
    describe 'trying to add a user that is not enrolled in the current team' do
      ...
      it 'shows a message saying that the user is already on the team', js: true do
        visit team_manage_users_path(user.teams.first.slug)
        click_link 'Add'
    ...
    describe 'uncharving teams', js: true do
      let!(:user) { create :user, :with_archived_team_and_is_admin }
      let(:team_name) { user.teams.first.name }

      it 'successfully uncharving the team', js: true do
        visit teams_path
      ...
      it 'moves the archived team to select team section', js: true do
        visit teams_path
