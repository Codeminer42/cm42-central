...
const SearchTooltip = ({ aditionalClass = '' }) => (
  <div className={`col-sm-12 ${aditionalClass}`} data-id="search-tooltip">
    <div className="tooltip-header">
      ...
      <ul>
        <li>
          <span>{I18n.t('projects.search_tooltip.syntax')}</span>
        </li>
        <li>
          <p>
            {I18n.t('projects.search_tooltip.example', {
              story: I18n.t('activerecord.models.story.one'),
            })}
          </p>
        </li>
      </ul>
    ...
    <div className="col-sm-6 tooltip-content">
      <ul>
        <li>
          <p>{I18n.t('projects.search_tooltip.properties')}</p>
        </li>
        <li>
          <span>
      ...
      <ul>
        <li>
          <p>{I18n.t('projects.search_tooltip.people')}</p>
        </li>
        <li>
          <span>
            <b>Initials:</b> FB
    ...
    <div className="col-sm-6 tooltip-content">
      <ul>
        ...
        <li>
          <span>
            <b>created_at:</b> 2017/10/20
          </span>
        </li>
        <li>
          <span>
            <b>release_date:</b> 2017/10/30
          </span>
        </li>
      </ul>
    </div>
